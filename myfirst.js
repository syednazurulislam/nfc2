...
app.get('/assetdetails/',function(req,res){
  ...
  var  validAddress =req.query.validAddress;
  var  retunAddress =req.query.retunAddress;
  var  endAddress =req.query.endAddress;
...
console.log(city+" ===============================>city name fron the asset details");
  ...
  console.log(validAddress+" ==============================>this the address from assetdetails json form from other page");
  var j;
...
res.render('assetdetails.ejs', {detailss:state.details1,validAddress:validAddress,retunAddress:retunAddress,endAddress:endAddress,listofaddresses:data,city:city});
data.length=0;
 ...
 app.get('/assetdetailsreturn/',function(req,res){
  console.log("---------------------------------im in assetdetailsreturn--------------------------------------------")
  var  validAddress =req.query.validAddress;
  var  retunAddress =req.query.retunAddress;
  var  endAddress =req.query.endAddress;
  var  assetname =req.query.assetname;
...
console.log(city+" ===============================>city name fron the asset details");
  ...
  console.log(assetname);
  console.log("this address from asserdetails");
  console.log(address3+" ==============================>this the address from assetdetailsreturn json form from other page");
  var j;
  ...
  state.details1=res[0].details;
    ...
    multichain.getAddresses((err, addresses) => {
      ...
      while(addresses[i]){
        ...
        var query = { blockchainaddress2:addresses[--i] };
        dbo.collection("registerusers").find(query).toArray(function(err, result) {
        if (result[0]!=undefined){
          data.push(result[0]);
...
res.render('returnassetdetails.ejs', {detailss:state.details1,validAddress:validAddress,retunAddress:retunAddress,endAddress:endAddress,listofaddresses:data,city:city});
data.length=0;
 ...
 app.post('/staylogin',function(req,res){
  var validAddress = req.body.validAddress;
  var retunAddress = req.body.retunAddress;
  var endAddress = req.body.endAddress;

  var city = req.body.city;
  console.log(validAddress+"=================================>addres this is from stayloin ");
  console.log(city+"=================================> city this is from stayloin ");
  var s = {
    status: 'valid',
    validAddress:validAddress,
    retunAddress:retunAddress,
...
app.post('/returnpro',function(req,res){
 
  var validAddress=req.body.validAddress;
      var retunAddress=req.body.retunAddress;
          var endAddress=req.body.endAddress;
   var city=req.body.city;
   console.log("this is from returnpro ")
   console.log(validAddress);
   console.log(retunAddress);
  ...
  multichain.getAddressBalances({
    address : retunAddress
  }).then(assertraw=>{
    console.log(assertraw);
    console.log(s)
    res.render('asset4.ejs', {assertrawb:assertraw,userdetailss:s});
...
multichain.sendAssetFrom({from: fromaddress, to: toaddress, asset: assetname,qty:1}, (err, tx) => {
  ...
  res.render('txid.ejs',{txid:g,validAddress:validAddress,retunAddress:retunAddress,endAddress:endAddress,city:city1});
